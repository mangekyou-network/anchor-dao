...
pub mod vote {
    ...
    pub fn light_instruction_first<'a, 'b, 'c, 'info>(
        ctx: Context<
            ...
            'c,
            'info,
            LightInstructionFirst<'info, { VERIFYINGKEY_VOTE.nr_pubinputs }>,
        >,
        inputs: Vec<u8>,
    ) -> Result<()> {
    ...
    pub fn light_instruction_second<'a, 'b, 'c, 'info>(
        ctx: Context<
            ...
            'c,
            'info,
            LightInstructionSecond<'info, { VERIFYINGKEY_VOTE.nr_pubinputs }>,
        >,
        inputs: Vec<u8>,
    ) -> Result<()> {
    ...
    pub fn light_instruction_third<'a, 'b, 'c, 'info>(
        ctx: Context<
            ...
            'c,
            'info,
            LightInstructionThird<'info, { VERIFYINGKEY_VOTE.nr_pubinputs }>,
        >,
        inputs: Vec<u8>,
    ) -> Result<()> {
